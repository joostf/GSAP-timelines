...
const tlSceneOne = gsap.timeline({ defaults: {duration: 1 }, paused:true })
...
function tlIntro() {
  ...
  tl.from(DOM.introTitle, .5, {opacity:0})
...
function tlPlanet() {
  ...
  tl.set(DOM.planet, {xPercent:100, x:'120%', scale: 0.15,  transformOrigin:'50% 0'})
...
function tlRocket() {
  ...
  tl.set(DOM.rocket, {xPercent:-20, yPercent:80, rotate:-20, transformOrigin:'50% 50%'})
...
function tlRocketFlames() {
  ...
  tl.to(DOM.rocketFlames, .1, { opacity:0})
