...
/* main timeline */
export function createSceneThree() {
...
function tlAlien() {
  return gsap.timeline({})
    .set(DOM.alien, {opacity:1, xPercent:150, yPercent:65, transformOrigin:'50% 0'})
    ...
    .set(DOM.alienEmoji, {x:'+=100', yPercent:'+=1175'})
    .to(DOM.alienEmoji, .5, {opacity:.3}, '+=.45')
    .to(DOM.scene4Trigger, .25, {opacity:1, yPercent:0}) 
}
